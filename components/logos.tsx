...
export function LogoIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            <path
                d="M376.81,506.19c34.29,3.32,87.86,4.99,113.81-20.96,25.95-25.95,22.38-80.95,19.05-111.9l-29.43-203.87c-9.37-64.88-88.75-91.28-135.1-44.92l-220.6,220.6c-46.85,46.85-19.32,127.08,46.42,135.3l205.86,25.75Z"
                stroke="currentColor"
                strokeWidth="9.54"
                className="opacity-50"
            />
            <path
                d="M250,701.35v-218.01c0-34.75,27.03-62.42,61.78-62.42,12.22,0,23.81,3.86,33.46,9.65l124.15,75.9v-69.06c0-26.15,7.02-54.21,20.41-77.8h-239.8v-61.22h500v61.22h-156.25c-51.66,2.55-63.14,48.47-63.14,77.8v106.49l109.35,66.85c16.08,9.65,26.38,15.44,33.46,15.44,12.87,0,14.8-16.73,14.8-47.62v-157.55h61.78v218.04c0,34.75-27.03,62.42-61.78,62.42-12.23,0-23.81-3.86-33.46-9.65l-124.15-75.9v85.69h-61.22v-123.12l-109.35-66.85c-16.09-9.65-26.38-15.44-33.46-15.44-12.87,0-14.8,16.73-14.8,47.62v157.52h-61.78Z"
                fill="currentColor"
            />
            <path
                d="M706.74,653.51c-14.11-1.37-36.15-2.05-46.83,8.62-10.68,10.68-9.21,33.31-7.84,46.05l12.11,83.89c3.85,26.7,36.52,37.56,55.59,18.49l90.77-90.77c19.28-19.28,7.95-52.29-19.1-55.68l-84.71-10.6Z"
                fill="currentColor"
