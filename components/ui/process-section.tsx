            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="relative h-full bg-card/30 backdrop-blur-md border border-white/5 rounded-2xl p-6 overflow-hidden transition-all duration-500 group-hover:bg-card/50 group-hover:border-white/10 group-hover:-translate-y-2 group-hover:shadow-[0_0_30px_-5px_rgba(0,0,0,0.3)]">
                                {/* Hover Glow */}
                                <div
