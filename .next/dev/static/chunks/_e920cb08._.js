...
"[project]/lib/data-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DataProvider({ children }) {
    _s();
    const [services, setServices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialServices);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>{
            const fetchServices = {
                "DataProvider.useEffect.fetchServices": async ()=>{
                    try {
            ...
            }["DataProvider.useEffect.fetchServices"];
            const fetchInsites = {
                "DataProvider.useEffect.fetchInsites": async ()=>{
                    try {
                        const res = await fetch(`${API_BASE}/blogs`);
                        const data = await res.json();
                        if (data.success && data.blogs) {
                            console.log(data.blogs);
                            const mapped = data.blogs.map({
                                "DataProvider.useEffect.fetchInsites.mapped": (blog)=>({
                                        _id: blog._id,
                                        title: blog.title?.en || "",
                            ...
                            }["DataProvider.useEffect.fetchInsites.mapped"]);
                            setInsights(mapped);
                        }
                    } catch (err) {
            ...
            }["DataProvider.useEffect.fetchInsites"];
    ...
    const updateService = (id, updated)=>{
        setServices((prev)=>prev.map((s)=>s._id === id ? {
                    ...s,
                    ...updated
                } : s));
    };
...
_s(DataProvider, "h/xgqg/USmQqcX0siPdbgH0LXyo=");
_c = DataProvider;
function useData() {
    _s1();
...
//# sourceMappingURL=_e920cb08._.js.map